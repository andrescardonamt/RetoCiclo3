...
function traerInformacion(){
    $.ajax({
        url:"http://129.151.101.157:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacion(){
    ...
    if (validar()){
    $.ajax({
        url:"http://129.151.101.157:8080/api/Message/save",
        type:"POST",
        data:dataToSend,
        datatype:"JSON",
...
function editarInformacion(){
    ...
    if (validar()){
    $.ajax({
        url:"http://129.151.101.157:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function borrarElemento(idElemento){
    ...
    let dataToSend=JSON.stringify(myData);
    $.ajax({
        url:"http://129.151.101.157:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
...
function obtenerItemEspecifico(idItem){
    $.ajax({
        dataType: 'json',
        url:"http://129.151.101.157:8080/api/Message/"+idItem,
        type:'GET',
